...
def main():
    ...
    parser.add_argument('--data_root', default='/home/yanze/test/PyTorch_GPU/pytorch-playground-master/', help='folder to save the model')
    ...
    #args.model_root        {'model_root': '/root/.torch/models'}
    ...
    if args.fwd_bits < 32:
        ...
        print(model_raw)
        val_ds_tmp = ds_fetcher(10, data_root=args.data_root, train=True,val=False,input_size=args.input_size)
        print("222222222222222222222222222222222")
        print(val_ds_tmp)
        print(type(val_ds_tmp))
        misc.eval_model(model_raw, val_ds_tmp, ngpu=1, n_sample=args.n_sample, is_imagenet=is_imagenet)

    # eval model
    val_ds = ds_fetcher(args.batch_size, data_root=args.data_root, train=True,val=False, input_size=args.input_size)
